...
const ContactForm = ({ data }) => {
  ...
  return (
    <>
      ...
      <div data-aos="zoom-in" className="bg-[#D9D9D9] py-10 mt-10">
        <div className="wrapper">
          <div className="md:flex items-center justify-between">
            <div className="w-full">
              <h1 className="text-[50px] leading-[60px] text-accent font-semibold">
                Location:
              </h1>
            </div>
            <div className="w-full flex justify-between items-center">
              <p>{data?.locationOne}</p>
              <div className="location-bar h-[50px] w-[4px] bg-[#383838] mr-5 md:flex hidden"></div>
            </div>
            <div className="w-full flex justify-between items-center">
